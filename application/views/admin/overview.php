...
|-------------------------------------------------------------------------------
|
|                   Buat mendisplay content di sidebar
|
|--------------------------------------------------------------------------------
|
|
...
/*
        <!-- Topbar -->
        <nav class="navbar navbar-expand-sm navbar-light topbar mb-4 static-top shadow" style="background-color: #84a9ac">
            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Pesurvei Per bulan</h6>
