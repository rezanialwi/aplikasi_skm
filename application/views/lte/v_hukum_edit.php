...
<div class="row">
<div class="col-lg-6">
<a href="<?php echo base_url().'admin/con_hukum'; ?>" class="btn btnsm
btn-primary">Kembali</a>
<br/>
<br/>
<div class="box box-primary">
<div class="box-header">
<h3 class="box-title">Edit Hukum</h3>
</div>
<div class="box-body">
		<?php foreach($responden as $u){ ?>
				 <form action="<?php echo base_url(). 'admin/con_hukum/update'; ?>" method="post">
